...
public class ExpandableListAdapter extends ArrayAdapter<Round> {
    //tweets est la liste des models à afficher

    View convertView;
    public ExpandableListAdapter(Context context, List<Round> rounds) {
        ...
        if(viewHolder == null){
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intentDisplayFaces = new Intent(getContext(), OptimizationRound.class);
